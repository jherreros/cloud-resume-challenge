...
- **Principal Platform Engineer** - October 2024 - Present
...
||||
|-|-|-|
| Linux         | Platform Engineering | Continuous improvement    |
| Kubernetes    | Product Ownership    | Communication             |
| Terraform     | Observability        | Teamwork                  |
| GitOps        | Azure                | Leadership                |
| Bash |||
